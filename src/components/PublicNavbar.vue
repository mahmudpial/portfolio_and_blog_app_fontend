    ...
    border-bottom:1px solid #0f1f38;">
        ...
        <div class="max-w-7xl mx-auto px-6 md:px-10 flex items-center justify-between h-16">
            ...
            <RouterLink to="/" class="flex items-center gap-1.5 group flex-shrink-0">
                ...
                <span class="w-2 h-2 rounded-full flex-shrink-0" style="background:#3B82F6;box-shadow:0 0 8px #3B82F6,0 0 16px #3B82F640;
          ...
          transition:transform .2s;margin-top:1px;" onmouseover="this.style.transform='scale(1.4)'"
            ...
            <div class="hidden md:flex items-center gap-1">
                <RouterLink v-for="link in navLinks" :key="link.to" :to="link.to"
                    ...
                    style="color:#A8C4E8;font-family:system-ui;" active-class="nav-active">
                    {{ link.label }}
                </RouterLink>
            </div>
          ...
          background:#dc262610;font-family:system-ui;">
                    ...
                    <div class="relative" ref="profileMenuRef">
                        <button @click="profileMenuOpen = !profileMenuOpen" class="flex items-center gap-2 px-3 py-1.5 rounded-xl border transition-all hover:scale-105"
                            ...
                            text-xs font-bold text-white"
                                style="background:linear-gradient(135deg,#1e3a5f,#2563EB);font-family:system-ui;">
                            ...
                            <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                ...
                                :style="profileMenuOpen ? 'transform:rotate(180deg);color:#60A5FA;' : 'color:#A8C4E8;'">
                        ...
                        <transition name="dropdown">
                            <div v-if="profileMenuOpen" class="absolute right-0 mt-3 w-48 rounded-2xl border p-2"
                                style="background:#0D1220;border-color:#1e3a5f;box-shadow:0 24px 64px #00000055;">
            ...
            <button class="md:hidden flex flex-col gap-1.5 p-2 rounded-lg transition-colors hover:bg-white/5"
                style="color:#A8C4E8;" @click="menuOpen = !menuOpen" aria-label="Toggle menu">
        ...
        <transition name="mobile-menu">
            <div v-if="menuOpen" class="md:hidden border-t overflow-hidden"
                style="background:#0D1220;border-color:#0f1f38;">
                <div class="px-6 py-5 flex flex-col gap-1">
                   ...
                   transition-all hover:bg-white/5" style="color:#A8C4E8;font-family:system-ui;"
                        active-class="mobile-active">
                        <span class="w-1 h-1 rounded-full flex-shrink-0" style="background:#3B82F6;"></span>
                        {{ link.label }}
                    </RouterLink>

                    <div class="h-px my-3" style="background:#0f1f38;"></div>
...
@keyframes logoPulse {
    ...
    0%,
    100% {
        box-shadow: 0 0 8px #3B82F6, 0 0 16px #3B82F640;
    }

    50% {
        box-shadow: 0 0 14px #3B82F6, 0 0 28px #3B82F680;
    }
}
