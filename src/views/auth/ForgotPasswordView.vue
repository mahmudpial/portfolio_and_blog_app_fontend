    ...
    <div class="min-h-screen flex items-center justify-center px-4 relative overflow-hidden"
        ...
        <div class="relative z-10 w-full max-w-md">
            ...
            <transition name="step" mode="out-in">
                <div v-if="step === 1" key="step1" class="rounded-2xl border p-8" style="background:#120E1C;border-color:#3B2A5A;
          box-shadow:0 0 60px #8B5CF610,0 40px 80px #00000040;">
            ...
            color:#f87171;font-family:system-ui;">
                  ...
                  color:#fff;font-family:system-ui;"
                     ...
                     flex items-center justify-center gap-2" style="background:#8B5CF6;box-shadow:0 0 24px #8B5CF635;
              font-family:system-ui;font-size:15px;">
                    ...
                    <div class="mt-6 text-center">
                        <RouterLink to="/login" class="inline-flex items-center gap-1.5 text-sm transition-colors"
                            style="color:#475569;font-family:system-ui;" onmouseover="this.style.color='#C084FC'"
                ...
                <div v-else key="step2" class="rounded-2xl border p-8" style="background:#120E1C;border-color:#3B2A5A;
          box-shadow:0 0 60px #8B5CF610,0 40px 80px #00000040;">
            ...
            color:#f87171;font-family:system-ui;">
                    ...
                    <form @submit.prevent="handleReset" class="space-y-4">
                       ...
                       font-mono transition-all" style="background:#0A0610;border:1px solid #3B2A5A;
            ...
            <p class="text-center text-xs mt-6" style="color:#475569;font-family:system-ui;">
                ...
                <RouterLink to="/login" class="font-medium transition-colors ml-1" style="color:#8B5CF6;"
                    onmouseover="this.style.color='#C084FC'" onmouseout="this.style.color='#8B5CF6'">
                    Sign in
                </RouterLink>
            </p>
        </div>
...
const pwStrengthColor = computed(() => {
    const c = ['#f87171', '#f87171', '#F59E0B', '#C084FC', '#4ade80']
