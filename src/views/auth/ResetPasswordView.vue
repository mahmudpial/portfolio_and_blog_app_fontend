        ...
        box-shadow:0 0 60px #8B5CF610,0 40px 80px #00000040;">
          ...
          color:#f87171;font-family:system-ui;">
                ...
                color:#fff;font-family:system-ui;"
                    ...
                    <div>
                        ...
                        <input v-model="form.token" type="text" placeholder="Paste token from email" required
                            class="w-full px-4 py-3 rounded-xl text-sm focus:outline-none transition-all" style="background:#0A0610;border:1px solid #3B2A5A;
            ...
            <p class="text-center text-xs mt-6" style="color:#475569;font-family:system-ui;">
                ...
                <RouterLink to="/login" class="font-medium ml-1 transition-colors" style="color:#8B5CF6;"
