          ...
          background-size:32px 32px;opacity:0.5;"></div>
            ...
            <div class="relative z-10 max-w-3xl mx-auto text-center">
                <p class="text-xs font-semibold uppercase tracking-widest mb-4"
                    style="color:#8B5CF6;font-family:system-ui;letter-spacing:.25em;">My Writing</p>
                <h1 class="font-bold leading-tight mb-5"
                    ...
                    <span style="color:#C084FC;text-shadow:0 0 40px #8B5CF650;">Insights</span>
                </h1>
            ...
            <div class="max-w-7xl mx-auto flex flex-col lg:flex-row gap-8 items-start">
                ...
                <div class="flex-1 min-w-0">
                    ...
                    <div v-if="loading" class="flex flex-col gap-5">
                        <div v-for="i in 4" :key="i" class="h-44 rounded-2xl animate-pulse" style="background:#120E1C;">
                        </div>
                    </div>
                    ...
                    <div v-else class="flex flex-col gap-5">
                     ...
                     transition-all duration-300 no-underline hover:-translate-y-1"
                            ...
                            <div class="w-48 flex-shrink-0 relative overflow-hidden"
                                style="background:linear-gradient(135deg,#180F28,#241338);min-height:160px;">
                         ...
                         group-hover:scale-110 absolute inset-0" />
                                ...
                                <div v-else class="absolute inset-0 flex items-center justify-center">
                                    <svg width="36" height="36" viewBox="0 0 24 24" fill="none" stroke="#3B2A5A"
                                        stroke-width="1">
                                        <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" />
                                        <polyline points="14 2 14 8 20 8" />
                                        <line x1="16" y1="13" x2="8" y2="13" />
                            ...
                            <div class="flex-1 p-6 flex flex-col justify-between">
                                <div>
                                    ...
                                    <div class="flex items-center gap-3 mb-3 flex-wrap">
                                        ...
                                        <span class="w-1 h-1 rounded-full" style="background:#3B2A5A;"></span>
                                        <span class="flex items-center gap-1.5 text-xs"
                                            style="color:#475569;font-family:system-ui;">
                                            <svg width="12" height="12" viewBox="0 0 24 24" fill="none"
                                                stroke="currentColor" stroke-width="2">
                                    ...
                                    <!-- Title -->
                                    <h2 class="font-bold text-white mb-3 transition-colors group-hover:text-violet-400"
                                    ...
                                    <div v-if="post.tags?.length" class="flex flex-wrap gap-1.5">
                                        <span v-for="tag in post.tags" :key="tag.id"
                                            class="text-xs px-2.5 py-1 rounded-full border" style="background:#0A0610;color:#C9B9E8;
                      border-color:#3B2A5A;font-family:system-ui;">
                            ...
                            transition-colors group-hover:text-violet-400" style="color:#8B5CF6;font-family:system-ui;">
                                    Read article
                        ...
                        <div class="flex gap-2">
                            <button v-for="page in visiblePages" :key="page" @click="fetchPosts(page)"
                                class="w-9 h-9 rounded-xl text-sm font-semibold transition-all hover:scale-105" :style="page === pagination.current_page
                                    ? 'background:#8B5CF6;color:#fff;box-shadow:0 0 12px #8B5CF640;border:1px solid #8B5CF6;'
                                    : 'background:#120E1C;color:#C9B9E8;border:1px solid #3B2A5A;'"
                ...
                <aside class="w-full lg:w-64 flex-shrink-0 flex flex-col gap-4 lg:sticky lg:top-32">
                    ...
                    <div class="rounded-2xl border overflow-hidden" style="background:#120E1C;border-color:#3B2A5A;">
                       ...
                       py-2 px-3 rounded-xl transition-all" :style="!activeCategory
                        ? 'background:#8B5CF615;color:#C084FC;'
                        : 'color:#C9B9E8;'"
                                ...
                                <span class="text-xs px-2 py-0.5 rounded-full"
                                    style="background:#180F28;color:#475569;">
                                    {{ posts.length }}
                                </span>
                            </li>
                       ...
                       py-2 px-3 rounded-xl transition-all" :style="activeCategory === cat.slug
                        ? 'background:#8B5CF615;color:#C084FC;'
                        : 'color:#C9B9E8;'" style="font-family:system-ui;">
                                <span>{{ cat.name }}</span>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="rounded-2xl border overflow-hidden" style="background:#120E1C;border-color:#3B2A5A;">
                       ...
                       transition-all hover:scale-105 border" :style="activeTag === tag.slug
                        ? 'background:#8B5CF6;color:#fff;border-color:#8B5CF6;box-shadow:0 0 10px #8B5CF640;'
                        : 'background:#0A0610;color:#C9B9E8;border-color:#3B2A5A;'" style="font-family:system-ui;">
                                # {{ tag.name }}
                            </span>
                    ...
                    <div class="rounded-2xl border p-5 relative overflow-hidden"
                        style="background:#120E1C;border-color:#3B2A5A;">
                        <div class="absolute inset-0 pointer-events-none"
                            style="background:radial-gradient(ellipse 200px 150px at 50% 100%,#8B5CF610,transparent 70%);">
                        </div>
                        <div class="relative z-10">
                            ...
                            <p class="text-xs leading-relaxed mb-4"
                                style="color:#C9B9E8;font-family:system-ui;line-height:1.6;">
                       ...
                       rounded-xl transition-all hover:scale-105"
                                style="background:#8B5CF6;box-shadow:0 0 14px #8B5CF635;font-family:system-ui;">
                                Get In Touch
                            </RouterLink>
                        </div>
                    </div>
