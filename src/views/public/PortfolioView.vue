<template>
    <div style="background:#05080F;min-height:100vh;">
        ...
        <section class="relative pt-28 pb-20 px-6 md:px-16 overflow-hidden">
          ...
          background:radial-gradient(circle,#3B82F612 0%,transparent 70%);filter:blur(60px);"></div>
          ...
          background-size:32px 32px;opacity:0.5;"></div>
            ...
            <div class="relative z-10 max-w-4xl mx-auto text-center">
                <p class="text-xs font-semibold uppercase tracking-widest mb-4"
                    style="color:#3B82F6;font-family:system-ui;letter-spacing:.2em;">My Work</p>
                <h1 class="font-bold leading-tight mb-5"
                    ...
                    <span style="color:#60A5FA;text-shadow:0 0 40px #3B82F650;">Projects</span>
                </h1>
                <p class="text-base leading-relaxed mb-8 mx-auto"
                    style="color:#A8C4E8;font-family:system-ui;max-width:500px;line-height:1.8;">
                ...
                <div class="grid grid-cols-3 gap-4 max-w-2xl mx-auto">
                    <div v-for="stat in headerStats" :key="stat.label"
                        ...
                        <div class="font-bold text-white mb-1" style="font-size:36px;font-family:'Georgia',serif;">
                            {{ stat.value }}<span style="font-size:22px;color:#60A5FA;">{{ stat.suffix }}</span>
                        </div>
        ...
        <section class="py-16 px-6 md:px-16">
            <div class="max-w-7xl mx-auto">
                ...
                <div v-if="loading" class="flex flex-col gap-5">
                    <div v-for="i in 3" :key="i" class="h-52 rounded-3xl animate-pulse" style="background:#0D1220;">
                    </div>
                </div>
                ...
                <div v-else-if="filteredProjects.length > 0" class="flex flex-col gap-5">
                   ...
                   hover:-translate-y-1 relative cursor-pointer" style="background:#0D1220;border-color:#1e3a5f;">

                        <!-- Category badge — top left -->
                        <div class="absolute top-5 left-5 z-20">
                            <span class="px-3 py-1.5 rounded-full text-xs font-bold uppercase tracking-wider text-white"
                                style="background:#3B82F6;font-family:system-ui;letter-spacing:.08em;">
                                {{ p.category || 'Project' }}
                            </span>
                        </div>
                        ...
                        <div class="flex flex-col md:flex-row">
                            ...
                            <div class="w-full md:w-64 h-52 flex-shrink-0 flex items-center justify-center relative overflow-hidden"
                                ...
                                <div v-else class="flex flex-col items-center gap-3">
                                    <svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="#1e3a5f"
                                        stroke-width="1">
                                ...
                                <div v-if="p.is_featured" class="absolute inset-0"
                                    style="background:linear-gradient(135deg,#3B82F608,transparent 60%);"></div>
                            </div>
                            ...
                            <div class="flex-1 p-7 flex flex-col justify-center">
                                ...
                                <p class="text-sm leading-relaxed mb-6"
                                    style="color:#A8C4E8;font-family:system-ui;line-height:1.8;max-width:600px;">
                                    {{ p.description }}
                                </p>
                           ...
                           border transition-all hover:scale-105 hover:border-blue-500"
                ...
                <div v-else class="text-center py-24 rounded-3xl border"
                    style="background:#0D1220;border-color:#1e3a5f;">
                    <svg class="mx-auto mb-5" width="52" height="52" viewBox="0 0 24 24" fill="none" stroke="#1e3a5f"
                        stroke-width="1">
                        <rect x="2" y="3" width="20" height="14" rx="2" />
                        <path d="M8 21h8M12 17v4" />
                    </svg>
        ...
        <!-- ── CTA SECTION ────────────────────────────────────── -->
        <section class="py-20 px-6 md:px-16" style="border-top:1px solid #0f1f38;">
          ...
          filter:blur(40px);transform:translateY(-50%) translateX(-30%);"></div>
                ...
                <div class="relative z-10 w-full max-w-2xl rounded-3xl border p-14 text-center overflow-hidden" style="background:#0D1220;border-color:#1e3a5f;
          box-shadow:0 0 60px #3B82F610,0 40px 80px #00000040;">
                    <!-- Inner glow -->
                    <div class="absolute inset-0 pointer-events-none"
                        style="background:radial-gradient(ellipse 500px 250px at 50% 50%,#3B82F608,transparent 70%);">
                    </div>
                    <div class="absolute inset-0 pointer-events-none" style="background-image:radial-gradient(circle,#3B82F610 1px,transparent 1px);
            background-size:28px 28px;opacity:0.4;"></div>
                    ...
                    <div class="relative z-10">
                        ...
                        <p class="text-sm leading-relaxed mb-8 mx-auto"
                            style="color:#A8C4E8;font-family:system-ui;max-width:420px;line-height:1.8;">
                     ...
                     rounded-2xl transition-all hover:scale-105"
                            style="background:#3B82F6;box-shadow:0 0 28px #3B82F640;font-family:system-ui;font-size:15px;">
